...
//		System.out.println(response.body());
		...
		//가공 처리 (Class Type vs JSON Type) maven repository에서 jackson 검색 해서 
		//Jackson Databind, Jackson Core, Jackson Annotations 3개 파일 같은 버전으로 다운로드.
		//라이브러러리 class path에 추가
...
//		}
	...
	//JSON TO JAVA  => 구글에 검색하면 자동으로 변환해주는 사이트 있음 그거쓰셈.
