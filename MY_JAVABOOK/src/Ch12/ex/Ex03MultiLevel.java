...
public class Ex03MultiLevel {
    public static void main(String[] args) {
        ...
        ColoredCircle obj1 = new ColoredCircle();
        Shape obj2 = obj1;
        // 2. 업캐스팅된 참조로 draw() 메서드를 호출해보세요
        obj2.draw();
        // 3. Shape -> Circle로 다운캐스팅하고 calculateArea() 메서드를 호출해보세요
        Shape obj3 = new Circle();
        if(obj3 instanceof  Circle) {
        	Circle obj4 = (Circle)obj3;        	
        	obj4.calculateArea();
        }
        // 4. Circle -> ColoredCircle로 다운캐스팅하고 applyColor() 메서드를 호출해보세요
        Circle obj5 = new ColoredCircle();
        if(obj5 instanceof  ColoredCircle) {
        	ColoredCircle obj6 = (ColoredCircle)obj5;        	
        	obj6.applyColor();
        }
